...
namespace cs2bh::sig
{
    ...
    { return Shared::FindPatternMatchesIn(module, pattern, wild); }

    ModuleInfo ModuleCodeFromName(const char *name)
    { return Shared::ModuleCodeFromName(name); }
}
